...
`DECISOES.md` e **fora do código**, como o enunciado pede. O porquê da priorização está na seção
"Fora de escopo".

Antes de escolher o que entregar, implementei o desenho inteiro para poder medir em vez de supor:
é de lá que vêm o `p99 = 70ms a 500 req/s` e o comportamento das ondas citados em `DECISOES.md`.
Esse protótipo fica fora desta entrega, em
